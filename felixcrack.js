...
const vcard = 'BEGIN:VCARD\n' 
            + 'VERSION:3.0\n' 
            + 'FN:𝙍𝙞𝙫𝙚𝙧𝙭😎🤙🏻\n' 
            + 'ORG:Creador De RX-BOT-V72\n' 
            + 'TEL;type=CELL;type=VOICE;waid=573012903896:+57 301 290 3896\n' 
            + 'END:VCARD'
//WhatsApp Conexión
const
	{
...
async function starts() {
	...
	console.log(color('[ BOT]','aqua'), color("BOT BY 𝙍𝙞𝙫𝙚𝙧𝙭 409", "red"))
	console.log('>', '[',color('INFO','blue'),']','Sigueme en mi ig😞✋🏻...')
	FxBot.on('qr', () => {
...
┃          「 *𝗛𝗢𝗟𝗔* 」
┃@${num.split('@')[0]}👋
┃B"〽️𝐁𝐢𝐞𝐧𝐯𝐞𝐧𝐢𝐝@ 𝐚𝐥 𝐠𝐫𝐮𝐩𝐨 𝐝𝐞 𝐖𝐡𝐚𝐭𝐬𝐀𝐩𝐩 !
┃*${mdata.subject}*
┗━━━━━━━━━━━━━━━━━
┏━━━━━━━━━━━━━━━━━
┃   「 *〽️ 𝐁𝐢𝐞𝐧𝐯𝐞𝐧𝐢𝐝@ !!* 」
┗━━━━━━━━━━━━━━━━━
┏━━━━━━━━━━━━━━━━━
┠⊷️ *Sigueme en mi canal de Youtube*:
┠⊷️*https://youtube.com/channel/UC6W4j16j0SKe3sbjLdi_S-Q*
┠⊷️*MUY PRONTO SUBIRE VIDEOS*
┗━━━━━━━━━━━━━━━━━
┏━━━━━━━━━━━━━━━━━
┠⊷️「 *DESCRIPCIÓN* 」
┠⊷️_𝐏𝐨𝐫 𝐟𝐚𝐯𝐨𝐫 𝐥𝐞𝐚 𝐥𝐚𝐬 𝐫𝐞𝐠𝐥𝐚𝐬 𝐪𝐮𝐞 𝐬𝐞 𝐞𝐧𝐜𝐮𝐞𝐧𝐭𝐫𝐚𝐧 𝐞𝐧 𝐥𝐚 𝐝𝐞𝐬𝐜𝐫𝐢𝐩𝐜𝐢𝐨𝐧 𝐝𝐞𝐥 𝐠𝐫𝐮𝐩𝐨_
┠⊷️Nombre:*\n*Edad:*\n*Rol (ej:support,rusher etc)
┗━━━━━━━━━━━━━━━━━
┏━━━━━━━━━━━━━━━━━
  ${mdata.desc}*
┗━━━━━━━━━━━━━━━━━`
...
//SETTING
       ...
       const kapankah = ['Otro día','Otra semana','Otro mes','Otro año']
		...
		mess = {
			wait: '「 👹 」 𝑬𝒔𝒕𝒂 𝑷𝒓𝒐𝒄𝒆𝒔𝒂𝒏𝒅𝒐, 𝒑𝒐𝒓 𝒇𝒂𝒗𝒐𝒓 𝒆𝒔𝒑𝒆𝒓𝒆...',
			success: '「 👹 」 𝑼𝒇𝒇, 𝑪𝒐𝒎𝒂𝒏𝒅ó 𝒄𝒐𝒏 é𝒙𝒊𝒕𝒐',
			nsfwoff: '「 👹 」𝑳𝒂 𝑭𝒖𝒏𝒄𝒊𝒐𝒏 𝑫𝒆 𝑵𝒔𝒇𝒘 𝑵𝒐 𝑬𝒔𝒕á 𝑨𝒄𝒕𝒊𝒗𝒂!',
			wrongFormat: '「 😠 」 𝑵𝒐 𝒔𝒆𝒂 𝒂𝒈𝒖𝒆𝒗𝒂𝒅𝒐 𝒆𝒔𝒄𝒓𝒊𝒃𝒂 𝒃𝒊𝒆𝒏 𝑬𝒍 𝒇𝒐𝒓𝒎𝒂𝒕𝒐',
			waitmusic: '「 👹 」 𝑬𝒔𝒑𝒆𝒓𝒆! 𝑬𝒔𝒕𝒐𝒚 𝒃𝒖𝒔𝒄𝒂𝒏𝒅𝒐 𝒕𝒖 𝒎𝒖𝒔𝒊𝒄𝒂\𝒏𝑬𝒏 𝒄𝒖á𝒏𝒕𝒐 𝒍𝒂 𝒆𝒏𝒄𝒖𝒆𝒏𝒕𝒓𝒆 𝒍𝒂 𝒆𝒏𝒗í𝒐!!!',
			waitimg: '「 👹 」 𝑬𝒔𝒑𝒆𝒓𝒆! 𝑬𝒔𝒕𝒐𝒚 𝒄𝒓𝒆𝒂𝒏𝒅𝒐 𝒕𝒖 𝒊𝒎𝒂𝒈𝒆𝒏!',
			nsfwoff: '「 👹 」𝑳𝒂 𝑭𝒖𝒏𝒄𝒊𝒐𝒏 𝑫𝒆 𝑵𝒔𝒇𝒘 𝑵𝒐 𝑬𝒔𝒕á 𝑨𝒄𝒕𝒊𝒗𝒂',
					musica: '𝑬𝒔𝒑𝒆𝒓𝒂 𝒖𝒏 𝒎𝒐𝒎𝒆𝒏𝒕𝒐, 𝒆𝒔𝒕𝒐𝒚 𝒃𝒖𝒔𝒄𝒂𝒏𝒅𝒐 𝒕𝒖 𝒄𝒂𝒏𝒄𝒊ó𝒏,*𝑹𝑬𝑪𝑼𝑬𝑹𝑫𝑬 𝑬𝑵 𝑺𝑬𝑮𝑼𝑰𝑹𝑴𝑬 𝑬𝑵 𝑴𝑰 𝑰𝑵𝑺𝑻𝑨𝑮𝑹𝑨𝑴*!!',
			imageoff: '「 👹 」𝑵𝒐 𝑷𝒖𝒆𝒅𝒐 𝑬𝒏𝒗𝒊𝒂𝒓 𝑭𝒐𝒕𝒐𝒔 𝑴𝒊𝒆𝒏𝒕𝒓𝒂𝒔 𝑵𝒐 𝑬𝒔𝒕𝒂 𝑨𝒄𝒕𝒊𝒗𝒂 𝑳𝒂 𝑭𝒖𝒏𝒄𝒊ó𝒏!',
			error: {
				stick: '「 👹 」𝑭 𝒏𝒐 𝒔𝒆 𝒑𝒖𝒅𝒐 𝒄𝒐𝒏𝒗𝒆𝒓𝒕𝒊𝒓 😞✋🏻',
				errostick: '❌Error al crear el sticker❌',
				Iv: '「 👹 」Link Invalido Prb'
			},
			only: {
				group: '「 ❗ 」Este Comando Solo Puede Ser Usado En Grupos',
				admin: '「 ❗ 」Usted no es admin 🤡',
...
case prefix+ 'leave':
					...
					FxBot.groupLeave (from) 
                     ...
                     setTimeout( () => {
					FxBot.updatePresence(from, Presence.composing) 
					FxBot.sendMessage(from, 'Adios Mlp👋', text) // ur cods
					}, 0)
                     break
...
case prefix+ 'tagall2':
				...
				FxBot.updatePresence(from, Presence.composing) 
					...
					FxBot.sendMessage(from, '𝙈𝙚𝙣𝙘𝙞𝙤𝙣 𝘿𝙚 𝙏𝙤𝙙𝙤𝙨'+teks+'✪ RX ┃ ᴮᴼᵀ ✪', text, {quoted: mek})
					break
                case prefix+ 'tagall3':
                case prefix+ 'marcar3':
				FxBot.updatePresence(from, Presence.composing) 
